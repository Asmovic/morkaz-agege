      ...
      <form className="w-full max-w-lg " onSubmit={handleSubmit}>
        <div className="flex flex-wrap mb-6">
          <div className="w-full md:w-1/2 mb-6 md:mb-0">
            ...
            <input
              className="appearance-none block w-full bg-gray-200 text-gray border border-gray-200-700 rounded py-3 px-4 mb-3 leading-tight focus:outline-none 
      focus:bg-white"
              required
              id="grid-first-name"
              type="text"
          ...
          <div className="w-full md:w-1/2 p-0 lg:px-4 ">
            <label
              className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
              htmlFor="email"
            >
